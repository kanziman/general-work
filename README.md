...
## 원격 저장소 및 MCP 설정 (Git & MCP Setup)

### Git 원격 저장소
이 저장소는 아래 원격 저장소의 `main` 브랜치에 연동되어 관리됩니다.
- URL: `https://github.com/kanziman/general-work.git`
...
- **Chrome DevTools MCP**: 구글 드라이브 및 웹 기반 인터랙션 보조
